...
Measured stress-test baseline (silent wrong fields still compile on large ontologies; subset prompts shrink token cost): [Evaluation — Track A](evaluation.md#track-a--distractor-ontology-stress-test).
